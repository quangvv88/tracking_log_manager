package vn.com.galaxy.trackinglogmanager.model
...
data class TrackingLogModel(
    ...
    @ColumnInfo(name = "version_app") var VersionApp: String? = null,
    @ColumnInfo(name = "version_code") var VersionCode: String? = null,
